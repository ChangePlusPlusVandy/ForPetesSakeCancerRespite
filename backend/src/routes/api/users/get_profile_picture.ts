...
router.get("/profile_picture", async (req, res) => {
    ...
    if (!mongoUser) {
        ...
        url = "https://firebasestorage.googleapis.com/v0/b/for-petes-sake-cancer-respite.appspot.com/o/defaultProfile.png?alt=media&token=2e4f8b9e-05d6-4c6a-a0fc-0b2c049b5f5d";
    }
    else {
